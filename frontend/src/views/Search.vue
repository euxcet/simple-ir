  ...
  <div class="main">
    ...
    <div class="form-container">
      ...
      <el-checkbox-group class="form-checkbox-group" v-model="checkedClass" @change="handleCheckedChange">
        <el-checkbox class="form-checkbox-in" v-for="option in options" :label="option" :key="option"> {{option}} </el-checkbox>
      </el-checkbox-group>
    ...
    <div class="result-container">
      <el-table :data="result" stripe height="560">
...
const classOptions = ['名词', '人名', '地名', '机构名', '其它专名', '数词', '量词', '数量词', '时间词', '方位词', '处所词', '动词', '形容词', '副词', '前接成分', '后接成分', '习语', '简称', '代词', '连词', '介词', '助词', '语气助词', '叹词', '拟声词']
export default {
  name: 'Search',
  data () {
    return {
